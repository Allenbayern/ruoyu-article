...
REJECTED_PRIOR_WORKS = [
    {"work": "兰香如故", "reason": "开播角度 daily-001 已写；本期仅以新人物杜翠雀+新问题（角色命运）入选，作品级去重黄灯已记录"},
    {"work": "交锋", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "欢迎来龙餐馆", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "空枪", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "玩具总动员5", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "早春晴朗", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "奥德赛", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "蜘蛛侠：崭新之日", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "绝望写手", "reason": "本期筛选未成题（历史理由未留痕）"},
    {"work": "生化危机：爆发夜", "reason": "本期筛选未成题（历史理由未留痕）"},
]
...
MATERIAL_SPECS = {
    "art-001": {
        ...
        "by_source": {
            "src-baijia-zhh": [
                "郑合惠子在《兰香如故》里就这么哭了一场",
                "你见过一个人跪在地上，抱着死去的闺蜜放声痛哭，哭到脖子上的青筋都暴起来，整个人抖得像筛糠一样吗？",
                "人就是她杀的",
