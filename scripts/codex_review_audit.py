#!/usr/bin/env python3
"""Read-only structural audit for Codex review inputs and recent run layout."""
...
def _parser() -> argparse.ArgumentParser:
    parser = _SafeArgumentParser(description="Audit Codex review governance and run structure without writing files.")
